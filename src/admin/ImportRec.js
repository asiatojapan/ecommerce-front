...
const ImportRec = () => {
    ...
    const clickSubmit = event => {
        ...
        axios.post(`${API}/students/importrec/${darwin_uid}`, formData,  { headers: { Authorization: "Bearer " + darwin_myTk }
    ...
    const newPostForm = () => (
     ...
     <Modal show={show} onHide={handleClose}>
       ...
       <Modal.Footer>
       <button className="btn btn-primary">Import Rec</button>
       </Modal.Footer>
       </form>
     </Modal>
     </div>
...
export default withRouter(ImportRec);
