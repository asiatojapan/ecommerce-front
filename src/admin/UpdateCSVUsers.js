...
const UpdateCSVUsers = () => {
    ...
    const clickSubmit = event => {
      ...
      console.log("Hw")
        axios.post(`${API}/users/update/${darwin_uid}`, formData, { headers: { Authorization: "Bearer " + darwin_myTk }
    ...
    const newPostForm = () => (
     ...
     <Modal show={show} onHide={handleClose}>
       <Modal.Header closeButton> Update CSV
       </Modal.Header>
...
export default withRouter(UpdateCSVUsers);
