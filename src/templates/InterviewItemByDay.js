    ...
    const children = (
      ...
      <div class="list-list" style={{backgroundColor: "#fff", padding: "0"}}>
        ...
        <div style={{marginBottom: "0px"}}>
          <div>
          <Icon prefix="fe" name="user" /><strong> 性別・年齢: </strong> {interview.student.gender === "Male" ? "男性": interview.student.gender === "male" ? "男性": "女性" }・{_calculateAge(interview.student.dob)}
          </div>
          <div>
        ...
        <div class="ml-auto align-items-center"> 
         ...
         <tr>
           ...
           <td style={{borderTop: "none", fontSize: "19px"}}> <span style={{fontSize: "12px", fontColor: "#eee"}}> 結果 </span><br/>       {resultInNice
                    (item.result)}</td>
         </tr>
         </tbody>
         </table>
