...
import PersonalDetails from './PersonalDetailsHalfResume';
import Education from './Education';
import Languages from './Languages';
import Experience from './ExperienceHalfResume';
...
export default (props) => (
  ...
  >
    <HalfResume size="A4" studentData={props.studentData} />
  </Document>
);